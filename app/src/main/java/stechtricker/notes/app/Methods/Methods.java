...
import stechtricker.notes.app.Constant.Constant;
...
public class Methods {
    ...
    private void loadad() {
        if (Constant.isAdmobInterAd) {
            ...
            InterstitialAd.load(context, context.getString(R.string.interstitia_ad_unit_id), adRequest, new InterstitialAdLoadCallback() {
                @Override
