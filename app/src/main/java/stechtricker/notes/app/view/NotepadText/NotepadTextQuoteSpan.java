...
public class NotepadTextQuoteSpan extends QuoteSpan {
    ...
    public NotepadTextQuoteSpan(int quoteColor, int quoteStripeWidth, int quoteGapWidth) {
    ...
    public NotepadTextQuoteSpan(Parcel src) {
        super(src);
