package stechtricker.notes.app.view.pflockscreen.fragments;
...
import stechtricker.notes.app.view.pflockscreen.views.PFCodeView;
...
public class PFLockScreenFragment extends Fragment {
    ...
    private static final String INSTANCE_STATE_CONFIG
        //    = "nemosofts.notes.app.view.pflockscreen.instance_state_config";
            = "stechtricker.notes.app.view.pflockscreen.instance_state_config";
