...
public class NotepadTextBulletSpan extends BulletSpan {
    ...
    public NotepadTextBulletSpan(int bulletColor, int bulletRadius, int bulletGapWidth) {
    ...
    public NotepadTextBulletSpan(Parcel src) {
        super(src);
